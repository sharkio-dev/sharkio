...
const cli_sniffer_controller_1 = require("./src/models/cli-sniffer-controller");
...
async function main() {
    ...
    const snifferController = new cli_sniffer_controller_1.CliSnifferManagerController(snifferManager);
